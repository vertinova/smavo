  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <p className="text-[11px] text-muted uppercase tracking-widest mb-1">Akademik</p>
          <h2 className="text-xl font-bold text-foreground tracking-tight">Data Siswa</h2>
        </div>
            ...
            <tbody>
              {isLoading ? [...Array(5)].map((_, i) => (
                ...
                <tr><td colSpan={7} className="px-4 py-16 text-center">
                  <GraduationCap size={36} className="mx-auto text-muted/30 mb-3" />
                ...
                <tr key={s.id} className="tr">
                  ...
                  <td className="td">
                    <div className="flex gap-0.5 justify-end">
                      <button onClick={() => openEdit(s)} className="p-1.5 rounded-lg hover:bg-foreground/[0.04] text-muted hover:text-foreground transition-colors"><Pencil size={15} /></button>
                      <button onClick={() => setDelId(s.id)} className="p-1.5 rounded-lg hover:bg-danger-muted text-muted hover:text-danger transition-colors"><Trash2 size={15} /></button>
                    </div>
                  </td>
                </tr>
              ))}
