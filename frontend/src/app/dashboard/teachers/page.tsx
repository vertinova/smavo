  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <p className="text-[11px] text-muted uppercase tracking-widest mb-1">Tenaga Pendidik</p>
          <h2 className="text-xl font-bold text-foreground tracking-tight">Guru & GTK</h2>
        </div>
                ...
                <tr key={t.id} className="tr">
                  ...
                  <td className="td">
                    <div className="flex gap-0.5 justify-end">
                      <button onClick={() => openEdit(t)} className="p-1.5 rounded-lg hover:bg-foreground/[0.04] text-muted hover:text-foreground transition-colors"><Pencil size={15} /></button>
                      <button onClick={() => setDelId(t.id)} className="p-1.5 rounded-lg hover:bg-danger-muted text-muted hover:text-danger transition-colors"><Trash2 size={15} /></button>
                    </div>
                  </td>
                </tr>
              ))}
