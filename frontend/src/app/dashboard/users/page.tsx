...
const EMPTY = { email: '', password: '', fullName: '', role: 'STAF_TU', nip: '', phone: '' };
                  ...
                  <tr key={u.id} className="tr">
                    <td className="td">
                      <div className="flex items-center gap-2.5">
                        ...
                        <span className="font-medium text-foreground">{u.profile?.fullName || '—'}</span>
                      </div>
                    </td>
                    <td className="td text-muted">{u.email}</td>
                    <td className="td font-mono text-xs text-muted">{u.profile?.nip || '—'}</td>
                    <td className="td">
              ...
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input className="input" value={form.nip} onChange={e => set('nip', e.target.value)} placeholder="18 digit NIP (opsional)" />
                  </div>
                  <div>
